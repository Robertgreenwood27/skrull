...
const Garbages = () => {
    ...
    useEffect(() => {
        // Update here: Include the 'garbage' folder in the image path
        setShuffledImages(shuffleArray([...Array(12).keys()].map(k => `garbage/garbage${k + 1}.png`)));
    ...
    useEffect(() => {
        ...
        // Update here: Include the 'garbage' folder in the new image path
        const newImages = shuffleArray([...Array(12).keys()].map(k => `garbage/garbage${k + 1}.png`));
