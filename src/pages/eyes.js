...
const Eyes = () => {
    ...
    useEffect(() => {
        // Update here: Include the 'eye' folder in the image path
        setShuffledImages(shuffleArray([...Array(12).keys()].map(k => `eye/eye${k + 1}.png`)));
    ...
    useEffect(() => {
        ...
        // Update here: Include the 'eye' folder in the new image path
        const newImages = shuffleArray([...Array(12).keys()].map(k => `eye/eye${k + 1}.png`));
